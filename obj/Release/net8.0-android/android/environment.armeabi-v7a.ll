...
@dso_cache = dso_local local_unnamed_addr global [522 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 764926379, ; hash 0x2d97d9ab, from name: aot-RestoranApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1895315885, ; hash 0x70f839ad, from name: libaot-RestoranApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 214
	...
	%struct.DSOCacheEntry {
		i64 1913410127, ; hash 0x720c524f, from name: RestoranApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 220
	...
	%struct.DSOCacheEntry {
		i64 2046622704, ; hash 0x79fcfbf0, from name: libaot-RestoranApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 241
	...
	%struct.DSOCacheEntry {
		i64 2616140383, ; hash 0x9bef225f, from name: aot-RestoranApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 319
	...
	%struct.DSOCacheEntry {
		i64 2949384957, ; hash 0xafcc0afd, from name: RestoranApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
