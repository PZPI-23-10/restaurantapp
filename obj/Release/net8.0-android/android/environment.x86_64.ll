...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670928, ; uint32_t jnienv_initialize_method_token (0x6001dd0)
	i32 100670927, ; uint32_t jnienv_registerjninatives_method_token (0x6001dcf)
...
@dso_cache = dso_local local_unnamed_addr global [522 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1137419434423888099, ; hash 0xfc8ecf3057628e3, from name: aot-RestoranApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 29
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 11426061850628228078, ; hash 0x9e9186b71c5683ee, from name: libaot-RestoranApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 315
	...
	%struct.DSOCacheEntry {
		i64 12826810943022875048, ; hash 0xb201fc97e3f8c1a8, from name: RestoranApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 357
	...
	%struct.DSOCacheEntry {
		i64 15358882732112536476, ; hash 0xd525b6785272e39c, from name: libaot-RestoranApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 16654588347267239486, ; hash 0xe720fbdcaf394e3e, from name: RestoranApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
	...
	%struct.DSOCacheEntry {
		i64 18195621003454747178, ; hash 0xfc83d4e5ea8e922a, from name: aot-RestoranApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-RestoranApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 510
...
@.env.3 = private unnamed_addr constant [37 x i8] c"5d1a69b3-07bc-480e-b099-99ecb4ac279e\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.restoranapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-RestoranApp.dll.so\00", align 16
